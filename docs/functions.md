...
#### Декоратор меняет поведение?
Да, декоратор именно для этого и предназначен — он расширяет или изменяет поведение объекта без его модификации. Декоратор оборачивает объект и добавляет новую функциональность до или после основного вызова.
